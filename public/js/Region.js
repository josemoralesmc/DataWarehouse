...
async function ObtenerRegiones() {
    ...
    const Regiones = await fetch("/api/region",{
        method: "GET",
        headers: {
...
async function ObtenerPaises() {
    const bearer = 'Bearer ' + JSON.parse(localStorage.getItem('Token'));
    const Paises = await fetch("/api/region/pais", {
        method: "GET",
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
...
async function ObtenerCiudades() {
    const bearer = 'Bearer ' + JSON.parse(localStorage.getItem('Token'));
    const Paises = await fetch("/api/region/pais/ciudad", {
        method: "GET",
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
...
async function EliminarRegion(id) {
    ...
    if (id) {
        deleteRegionbt.addEventListener('click', async () => {
            ...
            const bearer = 'Bearer ' + JSON.parse(localStorage.getItem('Token'));
            const EliminarRegion = await fetch("/api/region?id=" + `${id.target.id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Access-Control-Allow-Origin': '*',
...
async function EliminarPais(id) {
    ...
    if (id) {
        DeletePaisbt.addEventListener('click', async () => {
            console.log(id.target.id);
            const bearer = 'Bearer ' + JSON.parse(localStorage.getItem('Token'));
            const EliminarPais = await fetch("/api/region/pais?id=" + `${id.target.id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Access-Control-Allow-Origin': '*',
...
async function EliminarCiudad(id) {
    ...
    if (id) {
        DeleteCiudadbt.addEventListener('click', async () => {
            console.log(id.target.id);
            const bearer = 'Bearer ' + JSON.parse(localStorage.getItem('Token'));
            const EliminarCiudad = await fetch("/api/region/pais/ciudad?id=" + `${id.target.id}`, {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json',
                    'Access-Control-Allow-Origin': '*',
...
AgregarRegionbtn.addEventListener("click", async (e) => {
    ...
    const CrearRegion = await fetch("/api/region", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
...
AgregarPaisbt.addEventListener("click", AgregarPais)
    ...
    const CrearPais = await fetch("/api/region/pais", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
...
async function Region() {
  const bearer = 'Bearer ' + JSON.parse(localStorage.getItem('Token'));
  const ObtenerRegion = await fetch("/api/region", {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'Access-Control-Allow-Origin': '*',
...
async function Pais() {
  ...
  const bearer = 'Bearer ' + JSON.parse(localStorage.getItem('Token'));
  const ObtenerPaises = await fetch("/api/region/pais/region_pais?id=" + `${seleccionaRegion.value}`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'Access-Control-Allow-Origin': '*',
...
async function AgregarCiudad(){
    ...
    const CrearCiudad = await fetch("/api/region/pais/ciudad", {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Access-Control-Allow-Origin': '*',
...
function IdParaAtualizar(id2) {
    ...
    async function BtnactualizarRegion() {
        ...
        const EditarRegion = await fetch("/api/region?id=" + `${id2.target.id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Origin': '*',
...
function IdParaAtualizarPais(id) {
    ...
    async function BtnactualizarPais() {
        ...
        const EditarRegion = await fetch("/api/region/pais?id=" + `${id.target.id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Origin': '*',
...
function IdParaAtualizarCiudad(id) {
    ...
    async function BtnactualizarCiudad() {
        ...
        const EditarCiudad = await fetch("/api/region/pais/ciudad?id=" + `${id.target.id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'Access-Control-Allow-Origin': '*',
